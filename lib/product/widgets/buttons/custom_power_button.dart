                ...
                child: Container(
                  ...
                  child: Container(
                    ...
                    child: Icon(Icons.power_settings_new_rounded,
                        color: ref.watch(kTelemetryDataProvider).devicePowerStatus ? AppColors.WHOLE_NINE_YARDS : AppColors.SPACE_GREY, size: 100),
                  ),
                ),
              ),
              ref.watch(kTelemetryDataProvider).deviceConnectionStatus ? SizedBox() : CustomNoConnectionIconCard(top: 135, right: 5),
            ],
          ),
        ),
      ),
